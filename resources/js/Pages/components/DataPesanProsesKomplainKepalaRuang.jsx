...
const DataPesanProsesKomplainKepalaRuang = ({ user }) => {
        ...
        try {
            ...
            try {
                const emailResponse = await axios.post(
                    "http://193.168.195.191/api/sendemailToCSOKepalaRuang",
                    emailData
                );
        ...
        axios
            ...
            .then((response) => {
                ...
                const countdownInterval = setInterval(() => {
                    ...
                    // Hentikan countdown jika waktu tersisa sudah habis
                    if (timeRemainingInSeconds <= 0) {
                        clearInterval(countdownInterval);
                    }
                }, 1000); // Perbarui countdown setiap 1 detik
            })
            .catch((error) => {
                                ...
                                <div className="px-3 flex flex-col ml-2">
                                    ...
                                    <div className="flex items-center ">
                                        <div className="border border-black p-2 rounded-md flex items-center">
                                            ...
                                            <div
                                                className={`border border-black bg-gray-0 rounded-full px-3 text-black inline-block ml-2 text-center mr-2 ${
...
export default DataPesanProsesKomplainKepalaRuang;
