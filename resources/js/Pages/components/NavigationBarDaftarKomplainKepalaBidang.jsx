...
const navLink = [
    {
        ...
        route: "indexKepalaBidang",
    },
    {
        name: "Daftar Komplain",
        icon: ClipboardList,
        route: "daftarKomplainKepalaBidang",
    },
    {
        name: "Proses Komplain",
        icon: RefreshCcw,
        route: "prosesKomplainKepalaBidang",
    },
    {
        name: "Riwayat Komplain",
        icon: History,
        route: "riwayatKomplainKepalaBidang",
    },
];
const variants = {
    expanded: { width: "20%" },
...
const NavigationBarDaftarKomplainKepalaBidang = ({ user }) => {
...
export default NavigationBarDaftarKomplainKepalaBidang;
