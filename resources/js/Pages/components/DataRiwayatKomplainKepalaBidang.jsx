...
const DataRiwayatKomplainKepalaBidang = ({ user }) => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    `http://193.168.195.191/api/dataRiwayatKomplainLevelMerah`
                );
                    ...
                    {daftarKomplain.map((komplain) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <Link
                                    key={komplain.id}
                                    href={`isiPesanRiwayatKomplainKepalaBidang?id=${komplain.id}`}
...
export default DataRiwayatKomplainKepalaBidang;
