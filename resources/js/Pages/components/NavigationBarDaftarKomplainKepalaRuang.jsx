...
const navLink = [
    {
        ...
        route: "indexKepalaRuang",
    },
    {
        name: "Daftar Komplain",
        icon: ClipboardList,
        route: "daftarKomplainKepalaRuang",
    },
    {
        name: "Proses Komplain",
        icon: RefreshCcw,
        route: "prosesKomplainKepalaRuang",
    },
    {
        name: "Riwayat Komplain",
        icon: History,
        route: "riwayatKomplainKepalaRuang",
    },
];
const variants = {
    expanded: { width: "20%" },
...
const NavigationBarDaftarKomplainKepalaRuang = ({ user }) => {
...
export default NavigationBarDaftarKomplainKepalaRuang;
