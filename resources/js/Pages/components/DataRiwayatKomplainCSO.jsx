        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    `http://193.168.195.191/api/dataRiwayatKomplainAllLevel`
                );
                    ...
                    {daftarKomplain.map((komplain) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <Link
                                    key={komplain.id}
                                    href={`isiPesanRiwayatKomplainCSO?id=${komplain.id}`}
...
export default DataRiwayatKomplainCSO;
