...
const DataRiwayatKomplainKepalaRuang = ({ user }) => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    `http://193.168.195.191/api/dataRiwayatKomplainLevelHijau`
                );
                    ...
                    {daftarKomplain.map((komplain) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <Link
                                    key={komplain.id}
                                    href={`isiPesanRiwayatKomplainKepalaRuang?id=${komplain.id}`}
...
export default DataRiwayatKomplainKepalaRuang;
